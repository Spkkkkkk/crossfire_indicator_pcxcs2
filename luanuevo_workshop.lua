...
-- Rellena estas URLs antes de subirlo al workshop.
local REMOTE_FILES = {
    ["1.png"] = "https://your-site.com/1.png",
    ["2.png"] = "https://your-site.com/2.png",
    ["3.png"] = "https://your-site.com/3.png",
    ["4.png"] = "https://your-site.com/4.png",
    ["5.png"] = "https://your-site.com/5.png",
    ["headshot.png"] = "https://your-site.com/headshot.png"
}

-- Fuente: spytrcheat/cs2-spytr-offsets offsets.json, recibido el 2026-03-19.
local OFFSETS = {
...
local function get_local_controller()
    ...
    local controller = cs2:ru64(client_base + OFFSETS.dwLocalPlayerController)
...
local function read_local_kill_count(controller)
    ...
    return cs2:ru8(controller + kill_count_offset)
end
...
local function read_local_headshot_count(controller)
    ...
    local action_tracking = cs2:ru64(controller + action_tracking_offset)
    if not action_tracking or action_tracking == 0 then
        return nil
    end

    return cs2:ru32(action_tracking + headshot_count_offset)
end
...
function main()
    ...
    log("[kill-photo] Workshop version cargada.")
    return 1
end
...
function on_frame()
    ...
    if kill_count ~= nil then
        ...
        elseif kill_count > last_kill_count then
            popup_image_index = math.max(1, math.min(MAX_STREAK_IMAGE, kill_count))
...
function on_unload()
    ...
    log("[kill-photo] Workshop version descargada.")
end
